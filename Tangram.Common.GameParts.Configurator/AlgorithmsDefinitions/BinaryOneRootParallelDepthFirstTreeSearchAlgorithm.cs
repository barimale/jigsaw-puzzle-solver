...
{
    public class BinaryOneRootParallelDepthFirstTreeSearchAlgorithm : Algorithm<FindBinaryFittestSolution>, IExecutableAlgorithm
    {
        private const string NAME = "BinaryOneRootParallelDepthFirstTreeSearchAlgorithm";
        private const int ROOT_HAS_TO_BE_TREATED_AS_SINGLE_SO_SKIP_IT = 1;

        public BinaryOneRootParallelDepthFirstTreeSearchAlgorithm(
        ...
        public override async Task<AlgorithmResult> ExecuteAsync(CancellationToken ct = default)
        {
            ...
            try
            {
                ...
                var rootedAlgorithms = rootBlocks.Select(
                    p => new FindBinaryFittestSolution(
                        board,
        ...
        private async Task<FindBinaryFittestSolution> ExecuteAlgorithmAsync(FindBinaryFittestSolution pp, CancellationToken ct)
        {
