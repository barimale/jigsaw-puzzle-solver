...
{
    public class BreadthFirst_for_medium_board_needs_to_be_tested : PrintToConsoleUTBase
    {
        private AlgorithmUTConsoleHelper AlgorithmUTConsoleHelper;

        public BreadthFirst_for_medium_board_needs_to_be_tested(ITestOutputHelper output)
            : base(output)
        {
